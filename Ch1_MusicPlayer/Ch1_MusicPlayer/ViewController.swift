...
//        self.addViewsWithCode()
    ...
    func addPlayPauseButton() {
        ...
        button.addTarget(self,
                         action: #selector(self.touchUpPlayPauseButton(_:)),
        ...
        button.layer.borderColor = CGColor.init(red: 0, green: 0, blue: 0, alpha: 0.5)
    ...
    func updateTimeLabelText(time: TimeInterval) {
        ...
        let timeText = String(format: "%02ld:%02ld:%02ld", minute, second, miliseconds)
